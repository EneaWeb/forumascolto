...
<!-- SECTION HEADER -->
    ...
    <div class="section-header">
        <h2 class="dark-text"><a href="/news">News</a></h2>
        <h6>
        </h6>
    </div>
    ...
    <div class="container">
        <div class="col-md-6" style="text-align:left; border-right: 2px solid #e4e4e4">
            ...
            <div style="font-style:italic">{!!substr(strip_tags($posts[0]->content, '<br>'), 0, 130)!!}...</div>
        ...
        <div class="col-md-6" style="text-align:left; padding-left:25px">
            ...
            <div style="font-style:italic">{!!substr(strip_tags($posts[1]->content, '<br>'), 0, 130)!!}...</div>
